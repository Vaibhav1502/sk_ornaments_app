...
import '../../services/return_policy_service/return_policy_service.dart';
...
class _ReturnPolicyScreenState extends State<ReturnPolicyScreen> {
  late Future<ReturnPolicyData> _policyFuture;

  @override
  void initState() {
    super.initState();
    _policyFuture = ReturnPolicyService.fetchReturnPolicy();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<ReturnPolicyData>(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildHighlight(
                  ...
                  label: "RETURN PERIOD",
                  value: policyData.returnPeriod,
                ),
                const SizedBox(height: 16),
                _buildHighlight(
                  icon: Icons.verified_outlined,
                  label: "CONDITIONS",
                  value: policyData.conditions,
                ),
                const SizedBox(height: 40),
